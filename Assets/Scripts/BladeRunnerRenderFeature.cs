...
public class BladeRunnerRenderFeature : ScriptableRendererFeature
{
    [System.Serializable]
    ...
    class BladeRunnerPass : ScriptableRenderPass
    {
        Material mat;
        const string passName = "BladeRunnerPass";

        public BladeRunnerPass(Material material, RenderPassEvent evt)
        {
            mat = material;
            renderPassEvent = evt;
        ...
        public override void RecordRenderGraph(RenderGraph renderGraph, ContextContainer frameData)
        {
            ...
            TextureHandle tmp = UniversalRenderer.CreateRenderGraphTexture(renderGraph, descriptor, "_BladeRunnerTmp", false);
    ...
    BladeRunnerPass pass;

    public override void Create()
    {
        if (settings.material == null) return;
        pass = new BladeRunnerPass(settings.material, settings.renderPassEvent);
    }
