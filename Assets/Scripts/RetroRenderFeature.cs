...
public class RetroRendererFeature : ScriptableRendererFeature
{
    class RetroPass : ScriptableRenderPass
    {
        private Material material;

        public RetroPass(Material mat)
        {
            material = mat;
        ...
        public override void RecordRenderGraph(RenderGraph renderGraph, ContextContainer frameData)
        {
            ...
            desc.name = "_RetroTempTexture";
            desc.depthBufferBits = 0;
            TextureHandle tempTexture = renderGraph.CreateTexture(desc);

            using (var builder = renderGraph.AddRasterRenderPass<PassData>("RetroPass_Apply", out var passData))
            {
            ...
            using (var builder = renderGraph.AddRasterRenderPass<PassData>("RetroPass_CopyBack", out var passData))
            {
