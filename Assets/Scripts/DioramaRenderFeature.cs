...
public class DioramaRenderFeature : ScriptableRendererFeature
{
    [System.Serializable]
    ...
    class DioramaPass : ScriptableRenderPass
    {
        Material mat;
        const string passName = "DioramaPass";

        public DioramaPass(Material material, RenderPassEvent evt)
        {
            mat = material;
            renderPassEvent = evt;
        ...
        public override void RecordRenderGraph(RenderGraph renderGraph, ContextContainer frameData)
        {
            ...
            TextureHandle tmp = UniversalRenderer.CreateRenderGraphTexture(renderGraph, descriptor, "_DioramaTmp", false);
    ...
    public override void Create()
    {
        ...
        pass = new DioramaPass(settings.material, settings.renderPassEvent);
    }
