...
public class CozyFogRenderFeature : ScriptableRendererFeature
{
    [System.Serializable]
    ...
    class CozyFogPass : ScriptableRenderPass
    {
        Material mat;
        const string passName = "CozyFogPass";

        public CozyFogPass(Material material, RenderPassEvent evt)
        {
            mat = material;
            renderPassEvent = evt;
        ...
        public override void RecordRenderGraph(RenderGraph renderGraph, ContextContainer frameData)
        {
            ...
            TextureHandle tmp = UniversalRenderer.CreateRenderGraphTexture(renderGraph, descriptor, "_CozyFogTmp", false);
    ...
    public override void Create()
    {
        ...
        pass = new CozyFogPass(settings.material, settings.renderPassEvent);
    }
