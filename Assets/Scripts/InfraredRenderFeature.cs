...
public class InfraredRenderFeature : ScriptableRendererFeature
{
    [System.Serializable]
    ...
    class InfraredPass : ScriptableRenderPass
    {
        Material mat;
        const string passName = "InfraredPass";

        public InfraredPass(Material material, RenderPassEvent evt)
        {
            mat = material;
            renderPassEvent = evt;
        ...
        public override void RecordRenderGraph(RenderGraph renderGraph, ContextContainer frameData)
        {
            ...
            TextureHandle tmp = UniversalRenderer.CreateRenderGraphTexture(renderGraph, descriptor, "_InfraredTmp", false);
    ...
    public override void Create()
    {
        ...
        pass = new InfraredPass(settings.material, settings.renderPassEvent);
    }
