...
public class PastelRenderFeature : ScriptableRendererFeature
{
    [System.Serializable]
    ...
    {
        Material mat;
        const string passName = "PastelPass";

        public PastelPass(Material material, RenderPassEvent evt)
        {
            mat = material;
            renderPassEvent = evt;
        ...
        public override void RecordRenderGraph(RenderGraph renderGraph, ContextContainer frameData)
        {
            ...
            TextureHandle tmp = UniversalRenderer.CreateRenderGraphTexture(renderGraph, descriptor, "_PastelTmp", false);
    ...
    public override void Create()
    {
        ...
        pass = new PastelPass(settings.material, settings.renderPassEvent);
    }
