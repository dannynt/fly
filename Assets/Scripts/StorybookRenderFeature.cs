...
public class StorybookRenderFeature : ScriptableRendererFeature
{
    [System.Serializable]
    ...
    class StorybookPass : ScriptableRenderPass
    {
        Material mat;
        const string passName = "StorybookPass";

        public StorybookPass(Material material, RenderPassEvent evt)
        {
            mat = material;
            renderPassEvent = evt;
        ...
        public override void RecordRenderGraph(RenderGraph renderGraph, ContextContainer frameData)
        {
            ...
            TextureHandle tmp = UniversalRenderer.CreateRenderGraphTexture(renderGraph, descriptor, "_StorybookTmp", false);
    ...
    public override void Create()
    {
        ...
        pass = new StorybookPass(settings.material, settings.renderPassEvent);
    }
