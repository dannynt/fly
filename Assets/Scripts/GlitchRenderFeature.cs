...
public class GlitchRendererFeature : ScriptableRendererFeature
{
    class GlitchPass : ScriptableRenderPass
    {
        ...
        public override void RecordRenderGraph(RenderGraph renderGraph, ContextContainer frameData)
        {
            ...
            using (var builder = renderGraph.AddRasterRenderPass<PassData>("GlitchPass_Apply", out var passData))
            {
            ...
            using (var builder = renderGraph.AddRasterRenderPass<PassData>("GlitchPass_CopyBack", out var passData))
            {
